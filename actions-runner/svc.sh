...
SVC_NAME="actions.runner.nickgulrajani-vault-action-exampleapp.LT-APL0075987"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (nickgulrajani-vault-action-exampleapp.LT-APL0075987)"
